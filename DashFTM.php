        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    <a class="list-group-item list-group-item-action py-2 ripple" data-bs-toggle="list" href="#Dashboardf"><i class="fas fa-gauge-high fa-fw me-3"></i><span>Dashboard</span></a>
        ...
        <main style="margin-top: 80px;">
            <div id="content">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <?php
                    $activeTab = "Dashboardf";
                    if (isset($_GET['tab'])) {
                        $activeTab = $_GET['tab'];
                    }
                    ?>
                    <div class="tab-pane fade <?php if ($activeTab === "Dashboardf") echo "show active"; ?>" id="Dashboardf" style="height: 800px;">
                        <iframe src="dashBoardF.php"></iframe>
                    </div>
